...
const TESTIMONIALS = {
  2: { quote: "Ser agente de seguros no solo es asesorar para proteger un patrimonio; es también conectar con las personas identificando sus necesidades mientras brindas seguridad y confianza. Debes ser parte de su círculo de personas favoritas... ¡SIEMPRE!", name: "Faby Cárdenas", role: "Agente GNP · Avanza Capital" },
  6: { quote: "Llegué a Avanza Capital justo cuando buscaba estabilidad financiera y crecimiento profesional. Puedo decirte que mi vida cambió radicalmente, y es algo que todos los que me conocen notaron rápidamente.", name: "Lino Yein Chiu", role: "Agente GNP · Avanza Capital" },
  9: { quote: "Gracias a Avanza Capital, encontré la estabilidad que buscaba sin renunciar a mi tiempo con mi familia. Hoy manejo mi propio negocio y mis ingresos han superado mis expectativas.", name: "Marcia Raphael", role: "Agente GNP · Avanza Capital" },
};

const Qs = [
  { key:"situation", cat:"PERFIL GENERAL", q:"¿Cuál es tu situación laboral actual?", note:"No existe respuesta incorrecta — buscamos entender tu punto de partida.", opts:[{t:"Desempleado, buscando activamente",p:2},{t:"Empleado, pero busco una mejor oportunidad",p:2},{t:"Emprendedor o freelancer",p:3},{t:"Cuento con un negocio propio",p:2}]},
  { key:"education", cat:"FORMACIÓN ACADÉMICA", q:"¿Cuál es tu nivel máximo de estudios?", note:"La CNSF exige preparatoria terminada como mínimo para la certificación oficial de Agente de Seguros.", opts:[{t:"Secundaria o menos",p:0,hard:true,hardReason:"education"},{t:"Preparatoria terminada",p:1,val:"prepa"},{t:"Carrera universitaria trunca o en curso",p:2,val:"trunca"},{t:"Carrera universitaria terminada",p:3,val:"carrera"},{t:"Posgrado o especialización",p:3,val:"carrera"}]},
  { key:"vehicle", cat:"REQUISITOS OPERATIVOS", q:"¿Cuentas con vehículo propio en buen estado?", note:"La movilidad propia es indispensable para visitar prospectos y clientes en su domicilio u oficina.", opts:[{t:"No cuento con vehículo propio",p:0,hard:true,hardReason:"vehicle"},{t:"Sí, cuento con vehículo propio",p:3}]},
  { key:"availability", cat:"DISPONIBILIDAD", q:"¿Cuántas horas por semana puedes dedicar al inicio de tu carrera?", note:"Mayor disponibilidad se traduce directamente en mayores oportunidades de generar ingresos.", opts:[{t:"Menos de 10 horas semanales",p:0},{t:"Entre 10 y 20 horas semanales",p:1},{t:"Entre 20 y 40 horas semanales",p:2},{t:"Tiempo completo — disponibilidad total",p:3}]},
  { key:"experience", cat:"EXPERIENCIA COMERCIAL", q:"¿Tienes experiencia previa en ventas o atención al cliente?", note:"No es un requisito excluyente. El 40% de nuestros agentes exitosos comenzó sin experiencia en ventas.", opts:[{t:"Sin experiencia, pero con mucho interés en ventas",p:0,val:0},{t:"Experiencia informal o empírica",p:1,val:1},{t:"Experiencia formal en ventas o servicio al cliente",p:2,val:2},{t:"Vendedor profesional con trayectoria comprobable",p:3,val:3}]},
  { key:"social", cat:"HABILIDADES INTERPERSONALES", q:"¿Cómo te describes al relacionarte con personas que no conoces?", note:"Las habilidades sociales son entrenables. Lo que buscamos es apertura y disposición genuina.", opts:[{t:"Me resulta difícil iniciar conversaciones nuevas",p:0},{t:"Soy reservado, pero logro adaptarme con el tiempo",p:1},{t:"Soy sociable y me relaciono con relativa facilidad",p:2},{t:"Soy muy carismático y naturalmente persuasivo",p:3}]},
  { key:"rejection", cat:"MENTALIDAD Y RESILIENCIA", q:"Ante el rechazo de un prospecto, ¿cuál es tu reacción típica?", note:"En ventas, la resiliencia es la habilidad más valiosa y determinante del éxito a largo plazo.", opts:[{t:"Me afecta considerablemente y me cuesta reponerme",p:0},{t:"Lo acepto, aunque genera cierto desánimo temporal",p:1},{t:"Lo proceso como parte del proceso y continúo",p:2},{t:"Lo analizo y lo uso para mejorar mi siguiente abordaje",p:3}]},
  { key:"motivation", cat:"MOTIVACIÓN", q:"¿Qué describe mejor tu razón principal para ser agente de seguros?", note:"Los agentes con motivación clara y de largo plazo construyen las carteras más sólidas y duraderas.", opts:[{t:"Necesito generar ingresos de forma inmediata",p:0},{t:"Me interesa el sector financiero y de seguros",p:1},{t:"Busco libertad financiera y autonomía de horario",p:2},{t:"Quiero construir mi propio negocio y equipo de agentes",p:3}]},
  { key:"warmmarket", cat:"MERCADO NATURAL", q:"¿Con cuántas personas de tu entorno (familia, amigos, colegas) crees que podrías hablar sobre seguros?", note:"Tu mercado natural es la base de los primeros meses como agente. Mientras más amplio sea tu círculo, más rápido arrancas.", opts:[{t:"Menos de 10 personas",p:0},{t:"Entre 10 y 30 personas",p:1},{t:"Entre 30 y 60 personas",p:2},{t:"Más de 60 — tengo una red de contactos amplia",p:3}]},
  { key:"income", cat:"METAS FINANCIERAS", q:"¿Cuál es tu objetivo de ingreso mensual como agente de seguros?", note:"Nuestros agentes top superan los $100,000 MXN mensuales. La ambición es un predictor clave de éxito.", opts:[{t:"Entre $8,000 y $15,000 MXN mensuales",p:0},{t:"Entre $15,000 y $30,000 MXN mensuales",p:1},{t:"Entre $30,000 y $60,000 MXN mensuales",p:2},{t:"Más de $60,000 MXN — apunto al máximo potencial",p:3}]},
  { key:"city", cat:"UBICACIÓN", q:"¿En qué ciudad resides actualmente?", note:"Contamos con coordinadores y oficinas en Tijuana y Ensenada para apoyarte desde el primer día.", opts:[{t:"Tijuana",city:"tijuana"},{t:"Ensenada",city:"ensenada"},{t:"Rosarito",city:"tijuana"},{t:"Tecate",city:"tijuana"},{t:"Otra ciudad o estado",city:"tijuana"}], isCity:true},
];
...
function CircleProgress({ progress, size=160, stroke=4, img }) {
  ...
  return (
    <div style={{position:"relative",width:size,height:size}}>
      <svg width={size} height={size} style={{position:"absolute",top:0,left:0,transform:"rotate(-90deg)"}}>
        ...
        <circle cx={size/2} cy={size/2} r={r} fill="none" stroke={O} strokeWidth={stroke}
          strokeDasharray={circ} strokeDashoffset={offset} strokeLinecap="round"
          style={{transition:"stroke-dashoffset 0.5s linear", filter:`drop-shadow(0 0 6px ${O})`}}/>
      </svg>
      <div style={{position:"absolute",inset:stroke+6,borderRadius:"50%",overflow:"hidden",background:B,display:"flex",alignItems:"center",justifyContent:"center"}}>
        {img
...
/* ── INCOMING CALL ── */
function IncomingCall({ imgs, onDone }) {
  const [phase, setPhase] = useState("ringing"); // ringing | talking
  ...
  useEffect(() => {
    const r = new Audio(AUDIO_RING);
    r.loop = true; r.volume = 0.7;
    r.play().catch(() => {});
    ringRef.current = r;
    return () => { r.pause(); };
  }, []);
  ...
  const answer = () => {
    ...
    timerRef.current = setInterval(() => {
      elapsed += 0.5;
      setProgress(Math.min(100, (elapsed / VOICE_SECS) * 100));
  ...
  return (
    <div style={{minHeight:"100vh",display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",background:G.bg,padding:"30px 20px",position:"relative"}}>
      <style>{`
        @keyframes ping { 0%{transform:scale(1);opacity:0.6} 100%{transform:scale(1.9);opacity:0} }
        @keyframes btnPulse { 0%,100%{box-shadow:0 0 0 0 rgba(34,197,94,0.5)} 50%{box-shadow:0 0 0 16px rgba(34,197,94,0)} }
      `}</style>
      ...
      <div style={{textAlign:"center"}}>
        <div style={{fontSize:11,letterSpacing:"2.5px",color:G.dim,fontWeight:600,textTransform:"uppercase",marginBottom:28}}>
          {phase === "ringing" ? "Llamada entrante" : "En llamada con Mr. Mike"}
        </div>

        {/* Avatar */}
        <div style={{position:"relative",width:160,height:160,margin:"0 auto 24px"}}>
          {phase === "ringing" && [1,2,3].map(i => (
            <div key={i} style={{position:"absolute",inset:-i*20,borderRadius:"50%",border:`1.5px solid rgba(242,101,34,${0.3-i*0.08})`,animation:`ping ${1.2+i*0.4}s ease-out ${i*0.3}s infinite`}}/>
          ))}
          {phase === "ringing"
            ? <div style={{width:160,height:160,borderRadius:"50%",overflow:"hidden",border:`3px solid ${O}`,boxShadow:`0 0 30px rgba(242,101,34,0.4)`,background:B,position:"relative",zIndex:1,display:"flex",alignItems:"center",justifyContent:"center"}}>
                {imgs.wave ? <img src={imgs.wave} alt="Mr. Mike" style={{width:"100%",height:"100%",objectFit:"cover",objectPosition:"top center"}}/> : <div style={{fontSize:60}}>👋</div>}
              </div>
            : <CircleProgress progress={progress} size={160} stroke={5} img={imgs.wave}/>
          }
        </div>

        <div style={{fontSize:22,fontWeight:800,color:"white",marginBottom:6}}>Mr. Mike</div>
        <div style={{fontSize:13,color:G.muted,marginBottom:40}}>Avanza Capital · GNP Seguros</div>

        {phase === "ringing" && (
          <div style={{display:"flex",flexDirection:"column",alignItems:"center",gap:10}}>
            <button onClick={answer} style={{width:70,height:70,borderRadius:"50%",background:"linear-gradient(135deg,#22C55E,#16A34A)",border:"none",cursor:"pointer",display:"flex",alignItems:"center",justifyContent:"center",animation:"btnPulse 1.5s ease infinite"}}>
              <svg width="28" height="28" viewBox="0 0 24 24" fill="white">
                <path d="M6.6 10.8c1.4 2.8 3.8 5.1 6.6 6.6l2.2-2.2c.3-.3.7-.4 1-.2 1.1.4 2.3.6 3.6.6.6 0 1 .4 1 1V20c0 .6-.4 1-1 1-9.4 0-17-7.6-17-17 0-.6.4-1 1-1h3.5c.6 0 1 .4 1 1 0 1.3.2 2.5.6 3.6.1.3 0 .7-.2 1L6.6 10.8z"/>
              </svg>
            </button>
            <span style={{fontSize:11,color:G.dim}}>Contesta para continuar</span>
          </div>
        )}
        ...
        {phase === "talking" && (
          <div style={{display:"flex",flexDirection:"column",alignItems:"center",gap:8}}>
            <div style={{display:"flex",gap:4,alignItems:"center"}}>
              {[0,1,2,3,4].map(i => (
                <div key={i} style={{width:3,borderRadius:2,background:O,animation:`ping 0.8s ease ${i*0.12}s infinite`,height:`${12+Math.sin(i)*8}px`}}/>
              ))}
            </div>
            <span style={{fontSize:12,color:G.muted,marginTop:4}}>
              {Math.ceil(VOICE_SECS - (progress/100)*VOICE_SECS)}s restantes
            </span>
          </div>
        )}
      </div>
  ...
  return (
    <div>
      ...
      <div style={{display:"grid",gridTemplateColumns:"1fr auto",gap:16,alignItems:"center",marginBottom:24}}>
        <div>
          <span style={{display:"inline-block",padding:"4px 12px",borderRadius:100,background:"rgba(242,101,34,0.12)",border:"1px solid rgba(242,101,34,0.35)",color:O,fontSize:11,fontWeight:600,marginBottom:14}}>🔥 +200 agentes activos en Baja California</span>
          ...
          <p style={{fontSize:13,color:G.muted,lineHeight:1.65}}>Avanza Capital, agencia líder de <strong style={{color:"white"}}>GNP Seguros</strong>, busca agentes con mentalidad ganadora.</p>
        </div>
        <div style={{flexShrink:0}}><MrMike pose="wave" size={120} imgs={imgs}/></div>
      </div>
      ...
      <div style={{marginBottom:20}}>
        ...
        <div style={{display:"flex",flexDirection:"column",gap:7}}>
          {[["😤","Dependes de un horario fijo que no te deja vivir a tu manera"],["📉","Tus ingresos no crecen sin importar cuánto tiempo trabajas"],["🚪","Quieres ser tu propio jefe pero no sabes por dónde empezar"],["💸","Sientes que mereces ganar más de $100,000 MXN al mes"]].map(([ic,txt],i) => (
        ...
        <div style={{marginTop:12,padding:"11px 16px",background:"rgba(242,101,34,0.07)",border:"1px solid rgba(242,101,34,0.2)",borderRadius:11}}>
          <p style={{fontSize:13,color:"rgba(255,255,255,0.7)",lineHeight:1.65,margin:0}}>Si te identificas con alguna de estas situaciones, la carrera de <strong style={{color:"white"}}>Agente GNP Seguros</strong> puede ser exactamente lo que estás buscando.</p>
        </div>
      </div>
      ...
      <div style={{marginBottom:20}}>
        ...
        {[["01","Completa la evaluación de 10 preguntas (aprox. 3 minutos)"],["02","Si tu perfil califica, agenda una entrevista por Zoom"],["03","Una sesión de 15 minutos para despejar todas tus dudas — sin compromiso de contratación ni de incorporarte a GNP Seguros"]].map(([n,txt],i) => (
    ...
    <div style={{display:"flex",flexDirection:"column",justifyContent:"center",minHeight:"60vh"}}>
      ...
      <div style={{background:G.card,border:`1px solid ${G.brd}`,borderLeft:`3px solid ${O}`,borderRadius:16,padding:"24px 22px",marginBottom:28}}>
        ...
        <div style={{display:"flex",alignItems:"center",gap:12}}>
          <div style={{width:38,height:38,borderRadius:"50%",background:`linear-gradient(135deg,${O},${B})`,display:"flex",alignItems:"center",justifyContent:"center",fontSize:16,fontWeight:800,color:"white",flexShrink:0}}>{data.name[0]}</div>
          <div>
    ...
    <div>
      ...
      <div style={{display:"flex",flexDirection:"column",gap:9,marginBottom:20}}>
        {q.opts.map((o,i) => {
          const active = sel === o;
          return (
            <button key={i} onClick={()=>select(o)} style={{width:"100%",textAlign:"left",padding:"14px 16px",background:active?"rgba(242,101,34,0.1)":G.card,border:`1px solid ${active?O:G.brd}`,borderLeft:`3px solid ${active?O:"rgba(255,255,255,0.05)"}`,borderRadius:11,color:active?"white":"rgba(255,255,255,0.72)",cursor:"pointer",fontFamily:"inherit",fontSize:13.5,fontWeight:active?600:400,display:"flex",alignItems:"center",gap:13,transition:"all 0.15s ease",transform:active?"translateX(3px)":"none"}}>
      ...
      {q.note && <div style={{paddingTop:14,borderTop:`1px solid ${G.brd}`}}><p style={{fontSize:11,color:G.dim,lineHeight:1.7,margin:0}}>{q.note}</p></div>}
    </div>
  );
}
...
function Loading({ pct, imgs }) {
  ...
  return (
    <div style={{textAlign:"center"}}>
      <div style={{display:"flex",justifyContent:"center",marginBottom:18}}><MrMike pose="thumbsup" size={110} imgs={imgs}/></div>
  ...
  return (
    <div>
      <div style={{textAlign:"center",marginBottom:20}}>
        <div style={{display:"flex",justifyContent:"center",marginBottom:16}}><MrMike pose="thumbsup" size={130} imgs={imgs}/></div>
        ...
        <h2 style={{fontSize:"clamp(19px,4.5vw,25px)",fontWeight:900,lineHeight:1.15,marginBottom:13}}>
          {level} —{" "}
          <span style={{background:`linear-gradient(130deg,${O},${OL})`,WebkitBackgroundClip:"text",WebkitTextFillColor:"transparent"}}>Agente GNP Seguros</span>
        </h2>
      ...
      <div style={{background:G.card,border:`1px solid ${G.brd}`,borderRadius:16,padding:16,marginBottom:14}}>
        <div style={{fontSize:12.5,fontWeight:600,color:"rgba(255,255,255,0.75)",textAlign:"center",marginBottom:14}}>📅 Agenda tu entrevista por Zoom:</div>
        <iframe src={`https://crm.avanzacapital.mx/widget/booking/${calId}`} id={`cal_${calId}`} style={{width:"100%",border:"none",minHeight:520,borderRadius:10,display:"block"}} scrolling="no"/>
      </div>
      ...
      <div style={{background:"rgba(34,197,94,0.07)",border:"1px solid rgba(34,197,94,0.25)",borderRadius:12,padding:"13px 16px",marginBottom:12}}>
        <div style={{display:"flex",gap:10,alignItems:"flex-start"}}>
          ...
          <p style={{fontSize:12.5,color:"rgba(255,255,255,0.72)",lineHeight:1.7,margin:0}}>Una vez agendada tu cita, recibirás una <strong style={{color:"white"}}>confirmación por WhatsApp y correo electrónico</strong>. Mantente atento a ambos canales.</p>
        </div>
      </div>
      <p style={{fontSize:10.5,color:G.dim,textAlign:"center",marginTop:4}}>🔒 Tu información es estrictamente confidencial · Avanza Capital × GNP Seguros</p>
    </div>
  );
}
